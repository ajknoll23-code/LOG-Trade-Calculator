#!/usr/bin/env python3
"""
scripts/fantasypros_api_pipeline.py
...
USAGE: python3 scripts/fantasypros_api_pipeline.py
...
RAW_OUT_PATH = os.path.join(SCRIPT_DIR, "fantasypros_api_raw_2026.json")
NORMALIZED_OUT_PATH = os.path.join(SCRIPT_DIR, "fantasypros_api_normalized_2026.json")
REPORT_OUT_PATH = os.path.join(SCRIPT_DIR, "fantasypros_api_pipeline_report.md")
